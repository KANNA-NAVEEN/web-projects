...
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) // to execute the tests ordered by their numbers
...
//	}
	...
	@Test
	@Order(1)
	public void dbCategoryDefauttData() throws Exception {
	...
	@Test
	@Order(10)
	public void removeProductFromcar() {
	...
	@Test
	@Order(11)
	public void checkProductRemovedFromCar() {
